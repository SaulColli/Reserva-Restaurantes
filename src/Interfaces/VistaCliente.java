...
public class VistaCliente extends javax.swing.JPanel {
    ...
    public void CargarTablaCliente(String valor){
        String titulos[]={"Nombre", "Primer apellido", "Segundo apellido", "Tipo de cliente", "Telefono"};
        String registro[]=new String[5];
        String sSQL="";
        modelo =new DefaultTableModel(null, titulos);
        System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaa");
        ArrayList<Cliente> clientes = sistema.obtenerListaClientePorString(" ");
        
            
            for (Cliente cliente: clientes){
                registro[0]=cliente.getNombre();
                registro[1]=cliente.getPrimerApellido();
                registro[2]=cliente.getSegundoApellido();
                registro[3]=cliente.getTipoCliente();         
                registro[4]=cliente.getTelefono();
